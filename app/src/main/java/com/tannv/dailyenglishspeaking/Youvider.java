...
public class Youvider {
    ...
    public static String getWebContent(String webLink) throws IOException {
        ...
        webCon.setRequestProperty("User-Agent", "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.4; en-US; rv:1.9.2.2) Gecko/20100316 Firefox/3.6.2");
    ...
    public static boolean downloadEncodedStream(EncodedStream stream, String filePath, OnDownloadingProgress onDownloadingProgress){
...
//            connection.setReadTimeout(20000);
                ...
                if (fileLength > 0){
                    ...
                    if (newProgress > progress){
                        ...
                        if (onDownloadingProgress != null)
                            onDownloadingProgress.onDownloadingProgress(progress);
    ...
    public interface OnDownloadingProgress{
