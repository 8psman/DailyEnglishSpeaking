	...
	private class GetContacts extends AsyncTask<Void, Void, Void> {
		...
		public String loadJSONFromAsset() {
			...
			try {
				...
				InputStream is = getAssets().open(recieve);

				//
				System.out.println("Xin chao tat ca cac ban nhe: " + recieve);
		...
		protected Void doInBackground(Void... arg0) {
			...
			Log.d("Response: ", "> " + loadJSONFromAsset());
		...
		protected void onPostExecute(Void result) {
			 ...
			 * */
			ListAdapter adapter = new SimpleAdapter(TopicsActivity.this,
